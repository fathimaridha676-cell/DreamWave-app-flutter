...
//       "sound": "desifreemusic-forest-ambience-377891.mp3",
//     },
//     {
//       "title": "White Noise",
...
//   final List<double> _positions = List.generate(50, (_) => Random().nextDouble());
//   final List<double> _sizes = List.generate(50, (_) => 1 + Random().nextDouble() * 2);
...
/// ✨ Music Player Page
class SleepyPlayer extends StatefulWidget {
  final String title;
  final String soundFile;

  const SleepyPlayer({required this.title, required this.soundFile, super.key});

  @override
  State<SleepyPlayer> createState() => _SleepyPlayerState();
}

class _SleepyPlayerState extends State<SleepyPlayer>
    with SingleTickerProviderStateMixin {
  ...
  Future<void> _playAudio() async {
    try {
      ...
      await _audioPlayer.play(
        AssetSource('music/${widget.soundFile}'),
      ); // no 'assets/' here
